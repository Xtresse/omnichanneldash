...
const PRESETS = [
  ...
  { value: "q1", label: "Q1", range: () => { const y = todayD().getFullYear(); return [ymd(new Date(y, 0, 1)), ymd(new Date(y, 2, 31))]; } },
  { value: "q2", label: "Q2", range: () => { const y = todayD().getFullYear(); return [ymd(new Date(y, 3, 1)), ymd(new Date(y, 5, 30))]; } },
  { value: "q3", label: "Q3", range: () => { const y = todayD().getFullYear(); return [ymd(new Date(y, 6, 1)), ymd(new Date(y, 8, 30))]; } },
  { value: "q4", label: "Q4", range: () => { const y = todayD().getFullYear(); return [ymd(new Date(y, 9, 1)), ymd(new Date(y, 11, 31))]; } },
