...
// xtresse-orders-tracker, xtresse-ops-tracker, xtresse-finance-tracker). Do
// NOT edit a single copy — edit the master and run scripts/sync-core to
// propagate, so the dashboards can never drift.
//
