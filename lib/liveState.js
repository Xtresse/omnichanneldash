...
// Periods that also get a precomputed rep x day heat map. Same three — the
// grid is small (reps x days), and building it off rows the tick already has
// costs one extra daily-granularity aggregation, not another Shopify pull.
