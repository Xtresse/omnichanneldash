...
// imported by client components (SalesExplorer, XvieAccelerator) for pure
// helpers, and dataCache.js pulls in node:zlib — which must never end up in a
// client bundle. Only server routes / the SSR page import this file.
