...
function classifyOrderChannel(order) {
  ...
  // 2026-07-15 (Sam, "never include b2b orders ever"): this retail-SKU
  // check used to sit ABOVE the rep/b2b-tag checks, so a B2B order that
  // happened to contain a DTC retail SKU (the "DTCBOX" wholesale orders —
  // e.g. #6788942266591 Lexi Cavaliere $1,687.50, #6789761171679
  // Scott Stepe $2,046 on 7/14) was force-classified DTC, inflating
  // dtcNetSales by $3,733.50 that day and robbing the reps of credit.
  // Explicit b2b/rep tagging now always wins; the SKU signal only rescues
  // UNTAGGED retail orders from the pre-2026-04-01 date fallback below.
  if (order.hasDtcSku) {
