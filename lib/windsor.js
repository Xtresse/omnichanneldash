import { classifyOrder, isAdcs, isSubscription, repFromTags } from "./classify.js";
import {
  familyFor,
  fulfillmentLocFor,
  CHANNEL_COLORS,
...
export function buildDashboardData(rawRows) {
  ...
  // Sent as a flat array so the client can filter/sort/paginate without
  // another round-trip. Each row is the post-aggregation order, so 'net'
  // already has refunds subtracted.
