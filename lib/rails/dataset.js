...
// Full-history all-time rows now come off the frozen path (closed quarters
// from data/history-base.json, open quarter live + 10-day-sharded) — same row
// multiset as the old fetchWindsorAllTimeLight, just without re-pulling ~2
// years of unchanging orders on a cold /ask. Server-only (zlib); rails is only
// reached from app/api/ask. See lib/historyRows.js / lib/allTimeCache.js.
import { fetchShopifyAllRowsFrozen } from "@/lib/historyRows.js";
