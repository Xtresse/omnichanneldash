...
const RAILS = {
  ...
  get_budget_vs_actual: {
    description:
      "Budget vs Actual net sales by product family for the period. Includes month-by-month budget figures from the Google Sheet, the actuals computed from Shopify, and variance ($ + %) per family + per month. Returns mode='stub' if the budget sheet env vars aren't wired.",
    input_schema: {
      type: "object",
      properties: { period: PERIOD_SCHEMA },
    },
