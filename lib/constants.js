...
export function familyFor(sku) {
  ...
  // Any recognized-but-unmapped SKU rolls into Gummies (the flagship line) rather
  // than a dropped "Other" bucket (Sam, 2026-08-06) — so its revenue is counted,
  // not silently excluded from product rollups.
  return "Gummies";
}
