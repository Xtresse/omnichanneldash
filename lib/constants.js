...
export const SKU_FAMILY = {
  ...
  // ---- Sachets (2ct gummy "On The Go") — lumped into Gummies per Sam
  // (2026-05): sachets ARE gummies (smaller pack), so count them as Gummies
  // everywhere rather than a separate family.
  "X-GN-002CT-001": "Gummies",
  "X-GN-002CT-002": "Gummies",
  "X-GN-002CT-003": "Gummies",
  "X-GN-002CT-004": "Gummies",
  "X-GN-002CT-RAW": "Gummies",
...
export function familyFor(sku) {
  ...
  // Sachets (X-GN-002*) are lumped into Gummies (per Sam, 2026-05), so the
  // whole X-GN prefix maps to Gummies.
...
export const FAMILY_ORDER = ["Gummies", "Serum", "XVIE"];
...
export const CHANNEL_COLORS = {
  B2B: "#E6A403",    // primary brown — leadership dash convention
  DTC: "#302C29",    // teal/green
  ADCS: "#AA2D2D",   // warm orange-brown — used for sub-bucket only
  Total: "#1A1A1A",
};
