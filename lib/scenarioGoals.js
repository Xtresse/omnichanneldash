...
// The three target tiers shown on the dashboard. Sheet-backed (lib/budgetSheet);
// Base/Stretch fall back to the deck net figures above when the sheet is unwired.
// Budget has no hardcoded fallback — it comes only from the sheet.
export const TIERS = [
